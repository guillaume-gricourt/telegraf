...
- [kraken](https://github.com/guillaume-gricourt/telegraf-kraken) - Gather data from [Kraken API](https://docs.kraken.com/rest/#section/General-Usage/Support), a cryptocurrency exchange
